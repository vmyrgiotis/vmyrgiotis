...
Hello there! My name is Vasilis and I am a research scientist at the [UK Centre for Ecology and Hydrology](https://www.ceh.ac.uk). I have more than 12 years of experience in the development of data-driven computer models that describe biogeochemical processes in terrestrial ecosystems. I am interested at quantifying and monitoring how ecosystems function at those scales where actionable information is needed (local to nationa). I also have a keen interest in ecosystem sensing technologies. You can find my CV [here](cv.md) and see examples of past and ongoing work below.
